...
class LinkedList:
    ...
    # for itialization my class
    def __init__(self, linkedList = None):
        # One of the paradigms of OOP says that parameters should be encapsulated, so I encapsulated parameter self.head
    ...
    # like display func but return string
    def display1(self):
        s = ""
        current = self.__head
        while current.next is not None:
    ...
    # this func for intialization operator for
    def __iter__(self):
        ptr = self.__head
        # print(ptr.data)
        while ptr:
    ...
    #this function for turn over this list
    def reverse(self):
        res = None
        ptr = self.__head
        while ptr != None:
